...
const originalBg = `<div className="absolute inset-0 select-none pointer-events-none z-0">
...
content = content.replace(newBg, originalBg);
fs.writeFileSync('src/components/InvoiceViewer.tsx', content);
console.log('Restored original SVG');

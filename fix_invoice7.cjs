...
const section4Old = `<div className={\`grid grid-cols-1 \${isAdmin ? 'md:grid-cols-2' : ''} gap-4 md:gap-8 p-4 sm:p-6 md:p-8 bg-[#FAF9F7] border-t border-slate-100\`}>
...
const section4New = `<div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 p-4 sm:p-6 md:p-8 bg-[#FAF9F7] border-t border-slate-100">
...
if (content.includes(section4Old)) {
  ...
  console.log('Restored SECTION 4 without isAdmin hiding');
} else {
  console.log('Could not find section 4 modified block.');
}

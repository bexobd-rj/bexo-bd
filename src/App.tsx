    ...
    if (!isLoginMode) {
      return (
        <RegistrationFlow 
          ...
          onSwitchToLogin={() => { setIsLoginMode(true); setAuthError(''); }} 
        />
      );
    }
        ...
        >
          ...
          <div className="space-y-6">
            ...
            <form onSubmit={handleEmailAuth} className="space-y-4">
              {authError && (
                <div className="p-3 text-xs font-bold text-red-600 bg-red-50 border border-red-200 rounded-lg text-center">
                  {authError}
                </div>
              )}
              ...
              <button 
                ...
                className="w-full py-4 bg-slate-900 hover:bg-black disabled:opacity-70 disabled:cursor-not-allowed text-white rounded-xl font-bold uppercase tracking-widest text-xs shadow-md transition-all"
              >
            ...
            <button 
              ...
              className="w-full py-4 bg-white hover:bg-slate-50 text-slate-700 border-2 border-slate-200 rounded-xl font-bold uppercase tracking-widest text-xs transition-all flex items-center justify-center gap-3"
            >
